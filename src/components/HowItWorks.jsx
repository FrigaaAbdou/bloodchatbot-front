...
export function HowItWorks() {
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-5xl rounded-[36px] border border-white/5 bg-white/5 px-6 py-16 shadow-[0_65px_140px_-70px_rgba(244,114,182,0.55)] backdrop-blur-[2px]">
