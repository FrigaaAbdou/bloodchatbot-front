...
export function FAQ() {
  return (
    <section id="faq" className="bg-gradient-to-br from-white via-rose-50/40 to-white py-20">
      <div className="mx-auto max-w-4xl rounded-[32px] bg-white/80 px-6 py-12 shadow-[0_60px_120px_-70px_rgba(15,23,42,0.25)] backdrop-blur-sm">
        ...
        <dl className="mt-12 space-y-6">
          {faqs.map((faq) => (
            <div
              key={faq.question}
              className="rounded-3xl border border-rose-100/60 bg-white/90 p-6 shadow-[0_35px_80px_-60px_rgba(225,29,72,0.55)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_45px_100px_-55px_rgba(225,29,72,0.6)] motion-safe:animate-scale-in"
            >
