      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="group relative overflow-hidden rounded-3xl border border-rose-100/80 bg-white/90 p-8 shadow-[0_40px_90px_-50px_rgba(225,29,72,0.65)] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_55px_110px_-45px_rgba(225,29,72,0.75)] animate-scale-in"
            >
