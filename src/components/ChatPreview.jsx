...
export function ChatPreview() {
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-12 rounded-[42px] bg-white/85 px-4 py-14 shadow-[0_80px_160px_-80px_rgba(225,29,72,0.58)] backdrop-blur-md sm:px-6 lg:flex-row lg:items-start lg:gap-16 lg:px-10 lg:py-16">
        <div className="text-center lg:w-[60%] lg:pr-12 lg:text-left">
          ...
          <p className="mt-6 text-base leading-7 text-slate-600 sm:text-lg sm:leading-8 lg:max-w-[90%]">
          ...
          <ul className="mt-8 space-y-4 text-sm text-slate-600 lg:text-left">
            <li className="flex items-start justify-center gap-3 lg:justify-start">
              <span className="mt-1 inline-flex h-2.5 w-2.5 flex-shrink-0 rounded-full bg-rose-400 animate-pulse-soft" />
        ...
        <div className="relative mx-auto w-full max-w-xs sm:max-w-sm lg:w-[45%] lg:max-w-none">
          <div className="absolute -left-6 -right-10 -top-6 -bottom-6 -z-10 hidden rounded-[40px] bg-gradient-to-br from-rose-100/80 via-white to-slate-100 shadow-[0_75px_130px_-55px_rgba(244,114,182,0.35)] sm:block" />
          <div className="overflow-hidden rounded-[28px] border border-rose-100/80 bg-white/95 shadow-[0_55px_130px_-70px_rgba(15,23,42,0.55)] sm:rounded-[32px]">
